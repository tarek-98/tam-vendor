...
function EditProduct() {
  ...
  const product = singleProduct && singleProduct.product;
  ...
  const [videoPreview, setVideoPreview] = useState(product && product.video);
  ...
  function handleSave() {
    if (validateForm()) {
      ...
      dispatch(addProduct({ id: idVendor, productData: formDataObj }));
      setOptionsMenu(true);
      setSaved(true);
      console.log(id);
                    ...
                    >
                      <div className="form-group product-details d-flex flex-column gap-5 justify-content-center align-items-start w-100">
                        ...
                        >
                          ...
                          <Form.Control
                            type="text"
                            placeholder={product && product.hashtag}
                            className=""
                            name="hashtag"
